...
app.controller('MyCtrl', function($scope) {
    ...
    $scope.myDataInit = [{
        idFT: "FT1",
        listLFT: [{ idLFT: 'LFT1-de-la-FT1', descLFT: 'descLFT1' }, { idLFT: 'LFT2-de-la-FT1', descLFT: 'descLFT2' }]
    }, {
        idFT: "FT2",
        listLFT: [{ idLFT: 'LFT1-de-la-FT2', descLFT: 'descLFT1' }, { idLFT: 'LFT2-de-la-FT2', descLFT: 'descLFT2' }]
    }];
